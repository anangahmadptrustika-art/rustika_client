...
- **Live (Production):** https://client.rustika.co.id
...
| `NEXT_PUBLIC_SITE_URL` | `https://client.rustika.co.id` | ✅ |
...
3. Bucket → **Settings → CORS** → izinkan origin `https://client.rustika.co.id`
